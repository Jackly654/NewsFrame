...
/**
 * FoldingCirclesDrawable User: romainpiel Date: 07/04/2014 Time: 13:00
 */
public class FoldingCirclesDrawable extends Drawable implements Drawable.Callback
{
	private static final float MAX_LEVEL = 5000; // 这里可调速度
	...
	protected boolean onLevelChange(int level)
	{
		...
		mCurrentState = ProgressStates.values()[stateForLevel % 4]; // 调整 MAX_LEVEL 会崩溃,故 modify by fanjianglong 2015.10.21,4中颜色
		...
		// invalidate alpha (Paint#setAlpha is a shortcut for setColor(alpha
		// part)
	...
	public static class Builder
	{
		...
		{
			// Default values
			// mColors = context.getResources().getIntArray(R.array.google_colors); // Del by fanjianglong 2015.10.21
			
			// ↓↓↓ ADD ↓↓↓ by fanjianglong 2015.10.21
			mColors = new int[4];
			mColors[0] = DRCLR.CLR_HOLO_BLUE_LIGHT;
			mColors[1] = DRCLR.CLR_HOLO_RED_LIGHT;
			mColors[2] = DRCLR.CLR_HOLO_GREEN_LIGHT;
			mColors[3] = DRCLR.CLR_HOLO_ORANGE_LIGHT;
			// ↑↑↑ ADD ↑↑↑
		}
